// Case 4 — Trámite inscrito con devolución (constitución de empresa)
// Variables: kardex, montoDevolucion, telefono
            ...
            <tr>
              <td style="padding:12px 14px;">
                <p style="margin:0;font-family:${FONT};font-size:14px;line-height:22px;color:#0F172A;">
                  Asimismo, por el presente correo se adjunta INSCRIPCIÓN y RUC, tiene un monto por devolverse
                  de la SUNARP la suma de <strong>S/${data.montoDevolucion || '0.00'}</strong>.
